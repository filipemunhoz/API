$(function(){
	var meu_login	= "seucuca@email.com";
	...
	function onTarefaDeleteClick(){
		$(this).parent('.tarefa-item')
			...
			.hide('slow', function(){
				...
				$.post(server + "/tarefa", {usuario: meu_login, tarefa_id: $this.children(".tarefa-id").text(), _method: "DELETE"});
	...
	function onTarefaItemClick(){
		if(!$(this).is($lastClicked)){
			...
			var content	= "<div class='tarefa-id'>" + id + "</div>" + "<input type='text' class='tarefa-edit' value='" + text + "'>";			
